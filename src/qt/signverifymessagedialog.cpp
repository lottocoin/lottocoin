    ...
    model(0)
{
    ...
    ui->addressIn_SM->setPlaceholderText(tr("Enter a LottoCoin address"));
    ui->signatureOut_SM->setPlaceholderText(tr("Click \"Sign Message\" to generate signature"));

    ui->addressIn_VM->setPlaceholderText(tr("Enter a LottoCoin address"));
    ui->signatureIn_VM->setPlaceholderText(tr("Enter LottoCoin signature"));
#endif
